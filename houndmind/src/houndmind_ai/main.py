...
def build_modules(config) -> list:
    ...
    return [
        ...
        WebControllerModule("web_controller", **cfg("web_controller")),
        ...
        SensorHealthModule("sensor_health", **cfg("sensor_health")),
        ...
        TargetTrackingModule("target_tracking", **cfg("target_tracking")),
