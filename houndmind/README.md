...
For the Pi 4/5 camera URLs and the visual-only person/animal target-lock
setup, see [Live view and visual target tracking](docs/LIVE_VIEW_AND_TRACKING.md).

For the LAN gamepad controller, see [Doggie local web controller](docs/WEB_CONTROLLER.md).
